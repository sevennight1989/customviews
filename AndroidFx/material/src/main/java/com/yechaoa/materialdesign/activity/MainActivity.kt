...
import com.yechaoa.materialdesign.databinding.ActivityMaterialMainBinding

class MainActivity : ToolbarActivity<ActivityMaterialMainBinding>() {

    private lateinit var mList: MutableList<String>
    private lateinit var mAdapter: MainAdapter

    override fun getViewBinding(): ActivityMaterialMainBinding {
        return ActivityMaterialMainBinding.inflate(layoutInflater)
    }
