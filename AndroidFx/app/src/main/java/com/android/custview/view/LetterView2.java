...
public class LetterView2 extends View {
    ...
    public LetterView2(Context context) {
        super(context);
    }

    public LetterView2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        //获取属性
    ...
    public LetterView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
